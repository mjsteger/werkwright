...
(save-place-mode 1)
(message "before savehist")
;; savehist keeps track of some history
(use-package savehist)
(message "after use package")
...
;; (require 'midnight)
(message "before browse kill ring")
